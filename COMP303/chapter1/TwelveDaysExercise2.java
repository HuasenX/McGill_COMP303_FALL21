...
public class TwelveDaysExercise2 {
	
	static boolean ifDigit;
	
	public static void main(String[] args)
	{
		ifDigit = detectDigit(args[0]);
	...
	static String[] DDAYS = {"1st", "2nd","3rd","4th",
		"5th","6th","7th","8th",
		"9th","10th","11th","12th"
	};

	/*
	 * Return true if the user input is in digit, formal, false otherwise.
	 */
	static boolean detectDigit(String input) {
